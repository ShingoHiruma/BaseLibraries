...
int main(int argc, char *argv[])
{
	...
	bool bl1 = solver.solveICCG(total_size, 1.0e-8, 10000, 1.05, matAs1, vecB, results00);
	/* ICCOCG */
	bool bl2 = solver.solveICCG(total_size, 1.0e-8, 10000, 1.05, matCs1, vec0C, results01);
